...
public class TrailGraph {
	...
	// public LinkedList<Integer> targetList = new LinkedList<Integer>();
	...
	// LinkedList<LinkedList<TrailStop>> adjacencyList;

	public TrailGraph() {
		// trailStops = new LinkedList<TrailStop>();
		trailStops = new TreeSet<TrailStop>();
		// adjacencyList = new LinkedList<LinkedList<TrailStop>>();
